...
PC_MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v4_cyclegan/log/train_save_trans_exp_2_6/pc_model_00642214.ckpt"
...
# log path
LOG_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v4_cyclegan/log/train_save_trans_exp_2_6_1"
...
def init_network_variable(sess,train_saver):
	...
	if TRAINING_MODE == 1:
		train_saver['all_saver'].restore(sess,PC_MODEL_PATH)
