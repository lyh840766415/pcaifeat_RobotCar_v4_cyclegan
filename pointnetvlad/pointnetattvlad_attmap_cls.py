...
from Attention_NetVLAD.Attention_NetVLAD import *
...
def pointnetnormattvlad(point_cloud, is_training, bn_decay=None):
...
def pointnetattvlad(point_cloud, is_training, bn_decay=None):
    """PointNetVLAD,    INPUT is batch_num_queries X num_pointclouds_per_query X num_points_per_pointcloud X 3, 
                        OUTPUT batch_num_queries X num_pointclouds_per_query X output_dim """
    #batch_num_queries = point_cloud.get_shape()[0].value
    #num_pointclouds_per_query = point_cloud.get_shape()[1].value
    ...
    #print(net)
    net= tf.reshape(net,[-1,1024])
    point_weights = point_attention(point_cloud_xyz,net,is_training,bn_decay)
    #print(point_weights)
    point_weights = tf.reshape(point_weights, [-1, 1])
    #print(point_weights)
    #print(net)
