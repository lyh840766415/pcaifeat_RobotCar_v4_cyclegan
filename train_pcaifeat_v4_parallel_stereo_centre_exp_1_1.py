...
# log path
LOG_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v4_cyclegan/log/train_save_trans_exp_1_1"
...
def init_imgnetwork(is_training):
...
def init_pcainetwork():
	...
	if TRAINING_MODE != 1:
		img_placeholder, img_feat = init_imgnetwork(True)
	if TRAINING_MODE == 3:
