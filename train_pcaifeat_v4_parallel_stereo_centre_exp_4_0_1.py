...
PC_MODEL_PATH = "/data/lyh/lab/LPD-net/log/lpd_FNSF-20-06-23-15-06/model.ckpt"
...
# log path
LOG_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v4_cyclegan/log/train_save_trans_exp_4_0_1"
...
def init_pcnetwork(step):
	with tf.variable_scope("pc_var"):
		...
		pc_feat = forward(pc_placeholder,is_training_pl,bn_decay,1000)
