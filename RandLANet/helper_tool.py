...
class ConfigRobotCar:
    ...
    ratio = [4, 4, 4, 4, 2]  # sampling ratio of random sampling at each layer
...
class ConfigS3DIS:
    ...
    sub_sampling_ratio = [1, 4, 4, 4, 4, 2]  # sampling ratio of random sampling at each layer
    ratio = [1, 4, 4, 4, 4, 2]  # sampling ratio of random sampling at each layer
