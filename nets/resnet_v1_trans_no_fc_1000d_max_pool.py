...
from nets_v3.resnet_v1 import resnet_v1_50_1000d, resnet_arg_scope
...
def endpoints(image,pc_trans_feat,is_training):
	...
	with tf.contrib.slim.arg_scope(resnet_arg_scope(batch_norm_decay=0.9, weight_decay=0.0)):
		_, endpoints = resnet_v1_50_1000d(image, num_classes=None, is_training=is_training, global_pool=True)
	...
	img_feat = tf.reduce_max(endpoints['img_var/resnet_v1_50/block4'], [1, 2], name='pool5')
