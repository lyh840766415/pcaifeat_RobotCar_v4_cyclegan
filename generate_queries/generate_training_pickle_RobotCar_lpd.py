...
#global variable
PC_PATH = "/data/lyh/RobotCar/benchmark_datasets/oxford_lpd"
...
def main():
	...
	construct_query_dict(df_train,"training_queries_RobotCar_lpd.pickle")
	construct_query_dict(df_test,"test_queries_RobotCar_lpd.pickle")
