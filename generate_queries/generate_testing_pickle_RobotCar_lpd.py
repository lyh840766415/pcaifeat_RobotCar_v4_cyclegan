...
def construct_query_and_database_sets(base_path, runs_folder, folders, pointcloud_fols, filename, p, output_name):
	...
	#print(database_sets)
	#print(test_sets)
	output_to_file(database_sets, output_name+'_evaluation_database_lpd.pickle')
	output_to_file(test_sets, output_name+'_evaluation_query_lpd.pickle')


#For Oxford
folders=[]
runs_folder = "oxford_lpd/"
