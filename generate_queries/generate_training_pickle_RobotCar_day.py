...
#global variable
PC_PATH = "/data/lyh/RobotCar/benchmark_datasets/oxford_day/"
...
def main():
	...
	construct_query_dict(df_train,"training_queries_RobotCar_day.pickle")
	construct_query_dict(df_test,"test_queries_RobotCar_day.pickle")
