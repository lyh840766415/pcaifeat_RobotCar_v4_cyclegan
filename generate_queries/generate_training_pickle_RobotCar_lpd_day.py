...
#global variable
PC_PATH = "/data/lyh/RobotCar/benchmark_datasets/oxford_lpd_day"
...
def main():
	...
	for folder in folders:
		...
		df_locations['timestamp']=PC_PATH+"/"+folder+featurecloud_fols+df_locations['timestamp'].astype(str)+'.bin'
	...
	construct_query_dict(df_train,"training_queries_RobotCar_lpd_day.pickle")
	construct_query_dict(df_test,"test_queries_RobotCar_lpd_day.pickle")
