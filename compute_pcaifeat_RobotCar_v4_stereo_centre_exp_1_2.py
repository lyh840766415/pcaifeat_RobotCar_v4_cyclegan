...
DATABASE_FILE= 'generate_queries/oxford_evaluation_database_day.pickle'
QUERY_FILE= 'generate_queries/oxford_evaluation_query_day.pickle'
DATABASE_SETS= get_sets_dict(DATABASE_FILE)
QUERY_SETS= get_sets_dict(QUERY_FILE)

#model_path & image path
PC_MODEL_PATH = ""
IMG_MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v4_cyclegan/log/train_save_trans_exp_1_2/img_model_00642214.ckpt"
MODEL_PATH = ""
