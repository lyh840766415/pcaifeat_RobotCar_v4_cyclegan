...
IMG_MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v4_cyclegan/log/train_save_trans_exp_1_4/img_model_00642214.ckpt"
# log path
LOG_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v4_cyclegan/log/train_save_trans_exp_1_8"
...
def init_imgnetwork(is_training = True):
	with tf.variable_scope("img_var"):
		...
		img_feat = resnet.endpoints(img_placeholder,is_training=is_training,gating=False)
